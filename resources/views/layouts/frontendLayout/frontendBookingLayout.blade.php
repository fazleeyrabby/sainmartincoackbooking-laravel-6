...
<head>
    ...
    <!-- <script type="text/css" src="{{ asset('public/assets/frontend_asset/') }}/js/script.js"></script> -->
...
<!--------------Begin: Javascript---------------->
<!-- <script src="{{ asset('public/assets/frontend_asset') }}/js/jquery-3.3.1.slim.min.js"></script> -->
...
<script src="{{ asset('public/assets/frontend') }}/js/jquery-3.3.1.slim.min.js"></script>
...
<script>
    function checkCoachBooking(id){
        var fromDate =$("#fromDate").val();
        var toDate =$("#toDate").val();
        var _token = $('input[name="_token"]').val();
        $.ajax({
            url: "{{ route('coachbookingvalidation.fetch') }}",
            method: "POST",
            data: {
                fromDate,
                toDate,
            ...
            success: function(result) {
                if(result > 0){
                    alert('This date was Coach booked');
                        return false;
                }else{
                    return true;
                }
